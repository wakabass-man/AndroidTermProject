...
import kr.ac.kpu.s2015184027.termproject.framework.Recyclable;
import kr.ac.kpu.s2015184027.termproject.ui.view.GameView;
import kr.ac.kpu.s2015184027.termproject.utils.CollisionHelper;
...
public class MainGame {
    ...
    public boolean initResources() {
        ...
        objects.add(new ObstacleGenerator());
    ...
    public void update() {
        ...
        for (GameObject o1 : objects) {
            ...
            for (GameObject o2 : objects) {
                ...
                if (CollisionHelper.collides(obstacle)) {
